...
<template>
  <div>
    ...
    <div class="absolute -z-100000">
      <video src="https://cdn.jsdelivr.net/gh/MaxHu-arpg/gcIndex-cdn@0.0.1/dist/video/%E7%94%98%E9%9B%A8%E5%A4%9C%E6%99%9A.mp4" ref="bg" class="w-screen h-screen object-cover"
...
.myloading {
  ...
  height: 40px; /* 高度 */
  display: flex; /* 弹性布局 */
  align-items: center; /* 设置子项在y轴方向居中，应该是设置起点在中间，非常有用，不然动画很怪 */
}
...
.item { /* 小竖条 */
  ...
  width: 5px;
  background: #0a53be;
  margin: 0px 3px; /* 加margin，使竖条之间有空隙 */
  border-radius: 10px; /* 圆角 */
  animation: myloading 1s infinite; /* 动画：名称、时间、循环 */
}
...
.poster__arrow:nth-child(2) {
  animation-delay: 0.3s;
}

.poster__arrow:nth-child(3) {
  animation-delay: 0.6s;
}
</style>
